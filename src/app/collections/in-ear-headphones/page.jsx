...
import styles from './InEarHeadphones.module.css'
...
export default function InEarHeadphone() {
    const product = {
  ...
  return (
    ...
    <div className={styles.banner}>
      <div className={styles.bannerText}>
        <h1>หูฟัง In-Ear</h1>
        <p>คุณภาพเสียงระดับพรีเมี่ยม มาพร้อม ไมโครโฟน<br/>
        ที่ออกแบบมาให้สามารถใช้ได้กับทั้ง iPhone และ Android</p>
      </div>
    </div>
    <div className="route">
        <Link href="/">
